...
export function PanelConfigManagment({ title, contentType, canEdit }) {
  ...
  const renderCampaignManagment = (
    <Card>
      <CardHeader
        title="Panel Campaign managment"
        subheader={`Vidtrial's Panel Campaign's Details are Managed from here`}
        sx={{ mb: 3 }}
      />
      <Divider />
